...
class ViewFinishProjectsProgrammer extends StatefulWidget {
  @override
  _ViewFinishProjectsProgrammer createState() =>
      new _ViewFinishProjectsProgrammer();
}

class _ViewFinishProjectsProgrammer
    extends State<ViewFinishProjectsProgrammer> {
  @override
  void initState() {
    getFinishProjects();

...
class Helper {
  ...
  void _OnCreate(Database db, int version) async {
    ...
    await db.execute(
        "CREATE TABLE PROYECTO_INFO(ID_PROYECTO integer,TITULO text,DESCRIPCION text,FECHA_DE_PUBLICACION text,PRESUPUESTO text,F_TIPO_DE_PROYECTO integer,F_TERMINADO integer,F_VISIBILIDAD integer,F_EN_DESARROLLO integer,F_ABANDONO_C integer,F_ABANDONO_D integer,OBSERVACIONESABANDONO text,INTERVALO_DE_AVANCES integer,F_S_ENTREGABLES integer,FK_CLIENTE integer,codigo text);");
    await db.execute(

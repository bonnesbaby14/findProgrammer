...
class ViewDevelopmentProjectsClient extends StatefulWidget {
  @override
  _ViewDevelopmentProjectsClient createState() => new _ViewDevelopmentProjectsClient();
}

class _ViewDevelopmentProjectsClient extends State<ViewDevelopmentProjectsClient> {
  @override
  void initState() {
